...
st.title("🌈 Multi-Shape AI Air Canvas")
st.subheader("Detecting 10+ Geometric Shapes in Real-Time")
...
if st.sidebar.button("🚀 Re-Train AI Model"):
    with st.spinner("Generating data and training CNN+Transformer..."):
...
if st.sidebar.button("Undo Last Shape"):
...
with col2:
    st.info("How to use:\n1. Start the camera.\n2. Use your **index finger** to draw a shape.\n3. Keep your other fingers closed for better tracking.\n4. When you stop moving or move your hand away, the AI will classify the shape.")
...
if st.session_state.run_camera:
        ...
        if landmarks:
            ...
            if len(st.session_state.points) > 20:
                ...
                if roi is not None:
                    ...
                    prediction_label.success(f"Detected: {shape_name}")
    ...
    st.write("Camera is off. Click 'Start Camera' in the sidebar to begin.")
